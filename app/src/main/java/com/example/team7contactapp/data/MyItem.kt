...
object User {
    val dataList = mutableListOf<MyItem>(
        ...
        MyItem(R.drawable.profiles, "이종민", "010-9117-1065","jongmin@gmail.com", false, "인천시 부평구", "12월 32일", "프로젝트 화이팅!!!!"),
        MyItem(R.drawable.profiles, "이성진", "010-4659-8951","sungjin@gmail.com", false, "서울시 은평구", "8월9일", "안녕하세요 이성진입니다!!"),
